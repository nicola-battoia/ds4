...
This branch includes a measured SSD-streaming profile for the 14-core M4 Pro:

```sh
./run-deepseek-flash-m4pro-24gb.sh
```

It uses Flash Q2, a 32K allocated context, a 1K prefill chunk, 896 cached
experts, and 18 parallel expert reads. See the
[M4 Pro implementation and measurements](deepseek-flash-m4-pro-24gb.md) and
[current optimization investigation](m4pro-inference-investigation.md).
DSpark is incompatible with this SSD-streaming profile.
